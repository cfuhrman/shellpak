...
** Requirements
    ...
    - GNU Emacs 28.1 or greater (see [[file:emacs.d/EMACS-README.org][EMACS Documentation]])
    - GNU Make
    - rclone (under MS-Windows)
    - rsync

** Supported Platforms

   Provided the above requirements are met these dotfiles should work under most
   UNIX-type operating systems including Linux, *BSD, macOS, and Cygwin.  As I
   primarily use Debian GNU/Linux, Ubuntu Linux, Git Bash, and occasionally
   NetBSD, these operating systems are best supported.  YMMV.
